<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MALabReport.aspx.cs" Inherits="EMR.MALabReport" %>
...
<div>
    <br />
        ...
        <div class="centerblock" align="center">
                ...
                <asp:TextBox ID="txtHOM" runat="server" AutoPostBack="true"  spellcheck="false" Width="800px" autocomplete="off" Height="70px" BorderColor="#CC0000" BorderWidth="4px" placeholder="TYPE LAB REPORT NAME/HOM" OnTextChanged="txtImName_TextChanged">    </asp:TextBox>                 
...
<Columns>
<asp:BoundField  DataField="image_name" HeaderText="Lab Report Name"   ItemStyle-Wrap="false"/>
<asp:TemplateField HeaderText="Lab Report">
    <ItemTemplate>
